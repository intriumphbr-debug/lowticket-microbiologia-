      ...
      <div className="mobile-content">
        ...
        <div className="pricing-grid mx-auto flex max-w-4xl flex-col items-stretch gap-6 lg:flex-row lg:items-center lg:gap-6">
          ...
          <div
            ...
            style={{ backgroundColor: '#FFFFFF', border: '1px solid #DCE4EA' }}
          >
            <h3 className="font-grotesk text-lg sm:text-xl" style={{ color: '#062B45' }}>
              Plano Básico
            </h3>
            <div className="mt-3 flex items-baseline gap-2">
              <span className="font-grotesk text-3xl sm:text-4xl" style={{ color: '#062B45' }}>
                {BASIC_PRICE}
              </span>
            </div>
            ...
            <p className="mt-5 text-sm leading-relaxed" style={{ color: '#43505C' }}>
            ...
            <button
              ...
              style={{
                ...
                color: '#062B45',
                border: '1.5px solid #062B45',
                transition: 'all 200ms ease',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = '#062B45';
                e.currentTarget.style.color = '#FFFFFF';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = 'transparent';
                e.currentTarget.style.color = '#062B45';
              }}
            >
          ...
          <div
            ...
            style={{
              ...
              boxShadow: '0 24px 55px rgba(6, 43, 69, 0.35)',
            }}
          >
            {/* Selo */}
            <div
            ...
            <div className="mt-5 flex justify-center">
              ...
              >
                ...
                <p className="font-grotesk text-xs" style={{ color: '#EAF1F4' }}>Mockup completo</p>
                <p className="text-[10px]" style={{ color: '#A9BDCB' }}>Imagem em breve</p>
              </div>
            </div>
            ...
            <div
              ...
              style={{ backgroundColor: 'rgba(7, 95, 114, 0.45)', border: '1px solid rgba(214, 166, 46, 0.35)' }}
            >
              <p className="font-grotesk text-lg" style={{ color: '#D6A62E' }}>+140 RECURSOS VISUAIS</p>
              <p className="mt-1 text-xs font-semibold" style={{ color: '#EAF1F4' }}>
                Por + R$ 14,90, leve as 5 coleções
              </p>
            </div>

            <p className="mt-5 text-sm leading-relaxed" style={{ color: '#A9BDCB' }}>
            ...
            <div className="mt-6 text-center">
              ...
              <p className="mt-2 text-xs sm:text-sm font-semibold" style={{ color: '#A9BDCB' }}>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: '0 10px 26px rgba(7, 95, 114, 0.4)',
                transition: 'all 200ms ease',
              }}
              onMouseEnter={(e) => {
        ...
        <p className="mt-8 text-center text-sm" style={{ color: '#43505C' }}>
          <span className="font-bold" style={{ color: '#062B45' }}>Básico</span> {BASIC_PRICE} · 40 recursos
          <span className="mx-2" style={{ color: '#D6A62E' }}>→</span>
          <span className="font-bold" style={{ color: '#062B45' }}>Completo</span> {COMPLETE_PRICE} · 140 recursos
        </p>
